...
@interface RURadioPlaybackContext : MPPlaybackContext {
	...
	char _transitioningPlaybackModes;
...
@property (assign,getter=isTransitioningPlaybackModes,nonatomic) char transitioningPlaybackModes;              //@synthesize transitioningPlaybackModes=_transitioningPlaybackModes - In the implementation block
...
-(char)isTransitioningPlaybackModes;
-(MPAVItem *)prefixItem;
-(void)setTracks:(NSArray *)arg1 ;
-(void)setPlaybackLease:(SSVPlaybackLease *)arg1 ;
-(void)setTransitioningPlaybackModes:(char)arg1 ;
-(NSArray *)tracks;
@end
