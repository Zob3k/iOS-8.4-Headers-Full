...
@property (assign,nonatomic) char hasCameraFrontOnDuration; 
...
@property (assign,nonatomic) char hasCameraBackOnDuration; 
...
@property (assign,nonatomic) char hasCameraTorchOnDuration; 
...
-(void)copyTo:(id)arg1 ;
-(void)setHasCameraFrontOnDuration:(char)arg1 ;
-(char)hasCameraFrontOnDuration;
-(void)setHasCameraBackOnDuration:(char)arg1 ;
-(char)hasCameraBackOnDuration;
-(void)setHasCameraTorchOnDuration:(char)arg1 ;
-(char)hasCameraTorchOnDuration;
