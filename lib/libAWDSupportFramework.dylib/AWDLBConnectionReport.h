...
@interface AWDLBConnectionReport : PBCodable <NSCopying> {
	...
	SCD_Struct_AW20* _connectionReadyTimes;
	SCD_Struct_AW21* _resumptionFailureErrors;
	SCD_Struct_AW20* _resumptionFailureTimes;
	SCD_Struct_AW20* _resumptionSuccessTimes;
...
@property (nonatomic,readonly) unsigned connectionReadyTimesCount; 
...
@property (nonatomic,readonly) unsigned resumptionFailureErrorsCount; 
@property (nonatomic,readonly) int* resumptionFailureErrors; 
@property (nonatomic,readonly) unsigned resumptionSuccessTimesCount; 
@property (nonatomic,readonly) long long* resumptionSuccessTimes; 
@property (nonatomic,readonly) unsigned resumptionFailureTimesCount; 
...
-(unsigned)connectionReadyTimesCount;
-(void)clearConnectionReadyTimes;
-(long long)connectionReadyTimesAtIndex:(unsigned)arg1 ;
-(void)addConnectionReadyTimes:(long long)arg1 ;
-(unsigned)resumptionFailureErrorsCount;
-(void)clearResumptionFailureErrors;
-(int)resumptionFailureErrorsAtIndex:(unsigned)arg1 ;
-(void)addResumptionFailureErrors:(int)arg1 ;
-(unsigned)resumptionSuccessTimesCount;
-(void)clearResumptionSuccessTimes;
-(long long)resumptionSuccessTimesAtIndex:(unsigned)arg1 ;
-(void)addResumptionSuccessTimes:(long long)arg1 ;
-(unsigned)resumptionFailureTimesCount;
-(void)clearResumptionFailureTimes;
-(long long)resumptionFailureTimesAtIndex:(unsigned)arg1 ;
...
-(void)setConnectionReadyTimes:(long long*)arg1 count:(unsigned)arg2 ;
...
-(void)setResumptionFailureErrors:(int*)arg1 count:(unsigned)arg2 ;
-(long long*)resumptionSuccessTimes;
-(void)setResumptionSuccessTimes:(long long*)arg1 count:(unsigned)arg2 ;
-(long long*)resumptionFailureTimes;
-(void)setResumptionFailureTimes:(long long*)arg1 count:(unsigned)arg2 ;
